...
import { ADMIN_ROUTE, FORUM_ROUTE, LOGIN_ROUTE, PROFILE_ROUTE } from "../utils/consts";
    ...
    return (
        <Navbar style={{ backgroundColor: '#ce1531', fontFamily: 'PermianSansTypeface', fontSize: 24}}>
            ...
            {user_store?.isAuth ? 
                ...
                {user_store?.user.role === 'ADMIN' ? <Button className="mx-2" variant={"outline-light"} onClick={() => navigate(ADMIN_ROUTE)} >Админ панель</Button> : <div></div>}
